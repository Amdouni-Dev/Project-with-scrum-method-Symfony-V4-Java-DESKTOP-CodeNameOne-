...
public class GererGroupe extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Template/Feed/Admin/GererGroupes.fxml"));
