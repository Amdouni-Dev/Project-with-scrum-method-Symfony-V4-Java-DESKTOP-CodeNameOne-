...
public class AjouterPost extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Template/Feed/User/AjouterPost.fxml"));
