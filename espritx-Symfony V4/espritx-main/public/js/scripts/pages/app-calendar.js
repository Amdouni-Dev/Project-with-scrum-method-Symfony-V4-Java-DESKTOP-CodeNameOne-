...
"rtl" == $("html").data("textdirection") && (direction = "rtl"), "laravel" === $("body").attr("data-framework") && (assetPath = $("body").attr("data-asset-path")),
    ...
    document.addEventListener("DOMContentLoaded", (function () {
        var e, t = document.getElementById("calendar"),
            a = $(".event-sidebar"),
        ...
        if (f.length) {
            function x(e) {
                return e.id ?
                    "<div class='d-flex flex-wrap align-items-center'><div class='avatar avatar-sm my-0 me-50'><span class='avatar-content'><img src='" + assetPath + "images/avatars/" + $(e.element).data("avatar") + "' alt='avatar' /></span></div>" + e.text + "</div>" : e.text
            }
        ...
        var E = new FullCalendar.Calendar(t, {
            ...
            events: function (e, t) {
                var a, n = (
                    a = [],
                        $(".calendar-events-filter input:checked")
                            .each((function () {
                                a.push($(this)
                                    .attr("data-value"))
                            })), a);
            ...
            eventClick: function (t) {
                !function (t) {
                    (e = t.event).url && (t.jsEvent.preventDefault(), window.open(e.url, "_blank")),
                        a.modal("show"), d.addClass("d-none"),
                        r.addClass("d-none"),
