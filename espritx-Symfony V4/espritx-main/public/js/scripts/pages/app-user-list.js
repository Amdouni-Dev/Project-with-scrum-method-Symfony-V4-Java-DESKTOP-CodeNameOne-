$((function () {
    var e = $(".user-list-table"), t = $(".new-user-modal"), a = $(".add-new-user"), s = $(".select2"),
        n = $(".dt-contact"), l = {
            1: {title: "Pending", class: "badge-light-warning"},
            2: {title: "Active", class: "badge-light-success"},
            3: {title: "Inactive", class: "badge-light-secondary"}
        }, o = "../../../app-assets/", r = "app-user-view-account.html";
    "laravel" === $("body").attr("data-framework") && (o = $("body").attr("data-asset-path"), r = o + "app/user/view/account"), s.each((function () {
        ...
        columnDefs: [{
            ...
            targets: 1, responsivePriority: 4, render: function (e, t, a, s) {
                var n = a.full_name, l = a.email, i = a.avatar;
                if (i) var c = '<img src="' + o + "images/avatars/" + i + '" alt="Avatar" height="32" width="32">'; else {
            ...
            targets: -1, title: "Actions", orderable: !1, render: function (e, t, a, s) {
                return '<div class="btn-group"><a class="btn btn-sm dropdown-toggle hide-arrow" data-bs-toggle="dropdown">' + feather.icons["more-vertical"].toSvg({class: "font-small-4"}) + '</a><div class="dropdown-menu dropdown-menu-end"><a href="' + r + '" class="dropdown-item">' + feather.icons["file-text"].toSvg({class: "font-small-4 me-50"}) + 'Details</a><a href="javascript:;" class="dropdown-item delete-record">' + feather.icons["trash-2"].toSvg({class: "font-small-4 me-50"}) + "Delete</a></div></div></div>"
            }
        }],
        order: [[1, "desc"]],
