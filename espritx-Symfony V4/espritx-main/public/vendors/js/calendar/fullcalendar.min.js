var FullCalendar = function (e) {
    ...
    ge.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : ge.FullCalendarVDom = {
        Component: y, createElement: v, render: U, createRef: function () {
            ...
            for (i.debounceRendering = function (e) {
                t.push(e)
            }, U(v(me, {}), document.createElement("div")); t.length;) t.shift()();
        ...
        Gt = /\s*([ap])\.?m\.?/i, qt = /,/g, Yt = /\s+/g, Zt = /\u200e/g, Xt = /UTC|GMT/, Kt = function () {
            ...
            return e.prototype.format = function (e, t) {
                ...
                var o = this.standardDateProps, i = this.extendedSettings, a = function (e, t, n) {
                    return n.getMarkerYear(e) !== n.getMarkerYear(t) ? 5 : n.getMarkerMonth(e) !== n.getMarkerMonth(t) ? 4 : n.getMarkerDay(e) !== n.getMarkerDay(t) ? 2 : dt(e) !== dt(t) ? 1 : 0
    ...
    function $t(e, t, n) {
        ...
        return 1 === o && "short" === e.timeZoneName ? function (e) {
            ...
            return function (e, t, n, r) {
                var o = [];
                return "narrow" === r ? o.push(t) : "short" === r && o.push(t, " "), o.push(n.simpleNumberFormat.format(e)), "rtl" === n.options.direction && o.reverse(), o.join("")
            ...
            return function (r) {
                ...
                return function (e, t, n, r, o) {
                    return e = e.replace(Zt, ""), "short" === n.timeZoneName && (e = function (e, t) {
                        var n = !1;
                        return e = e.replace(Xt, (function () {
                            return n = !0, t
                        })), n || (e += " " + t), e
                    }(e, "UTC" === o.timeZone || null == t.timeZoneOffset ? "UTC" : Wt(t.timeZoneOffset))), r.omitCommas && (e = e.replace(qt, "").trim()), r.omitZeroMinute && (e = e.replace(":00", "")), !1 === r.meridiem ? e = e.replace(Gt, "").trim() : "narrow" === r.meridiem ? e = e.replace(Gt, (function (e, t) {
    ...
    function hn(e, t, n, r) {
        for (var o = {defs: {}, instances: {}}, i = Mn(n), a = 0, s = e; a < s.length; a++) {
            var l = kn(s[a], t, n, r, i);
            l && vn(l, o)
        }
        return o
    }
    ...
    function gn(e, t) {
        var n = e.instances[t];
        if (n) {
            var r = e.defs[n.defId], o = yn(e, (function (e) {
    ...
    var Rn = {id: String, groupId: String, title: String, url: String},
        _n = {start: fn, end: fn, date: fn, allDay: Boolean}, Tn = r(r(r({}, Rn), _n), {extendedProps: fn});

    function kn(e, t, n, r, o) {
        void 0 === o && (o = Mn(n));
        var i = xn(e, n, o), a = i.refined, s = i.extra, l = function (e, t) {
            var n = null;
    ...
    function xn(e, t, n) {
        return void 0 === n && (n = Mn(t)), pn(e, n)
    }

    function Mn(e) {
        return r(r(r({}, Sn), Tn), e.pluginHooks.eventRefiners)
    }
    ...
    function An(e, t) {
        var n, r, o = [], i = t.start;
        for (e.sort(Un), n = 0; n < e.length; n += 1) (r = e[n]).start > i && o.push({
            start: i,
            end: r.start
        }), r.end > i && (i = r.end);
    ...
    function Bn(e, t, n, r) {
        ...
        for (var d in e.instances) {
            var p = e.instances[d], f = u[(S = e.defs[p.defId]).defId], h = p.range, v = !S.allDay && r ? Nn(h, r) : h,
                g = Ln(v, n);
        ...
        for (var m in o) for (var y = 0, E = An(o[m], n); y < E.length; y++) {
            var S, D = E[y];
            f = u[(S = a[m]).defId], s.push({def: S, ui: f, instance: null, range: D, isStart: !1, isEnd: !1})
        }
        for (var c in i) for (var b = 0, C = An(i[c], n); b < C.length; b++) D = C[b], s.push({
            def: e.defs[c],
            ui: u[c],
            instance: null,
            range: D,
    ...
    var or = {start: fn, end: fn, allDay: Boolean};

    function ir(e, t, n) {
        var o = function (e, t) {
            var n = pn(e, or), o = n.refined, i = n.extra, a = o.start ? t.createMarkerMeta(o.start) : null,
    ...
    function ar(e, t) {
        return Wn(e.range, t.range) && e.allDay === t.allDay && function (e, t) {
    ...
    function sr(e, t, n) {
        return r(r({}, lr(e, t, n)), {timeZone: t.timeZone})
    }
    ...
    function ur(e, t, n) {
        var r = xn({editable: !1}, n), o = In(r.refined, r.extra, "", e.allDay, !0, n);
        return {def: o, ui: Zn(o, t), instance: pt(o.defId, e.range), range: e.range, isStart: !0, isEnd: !0}
    }

    function cr(e, t, n) {
        n.emitter.trigger("select", r(r({}, dr(e, n)), {
    ...
    function dr(e, t) {
        ...
        return r(i, (n = e, o = t.dateEnv, r(r({}, lr(n.range, o, n.allDay)), {allDay: n.allDay}))), i
    }
    ...
    function fr(e, t, n, r) {
        var o = Yn(e.defs, t), i = {defs: {}, instances: {}};
        for (var a in e.defs) {
            var s = e.defs[a];
            i.defs[a] = hr(s, o[a], n, r)
        }
        for (var l in e.instances) {
            var u = e.instances[l];
            s = i.defs[u.defId], i.instances[l] = vr(u, s, o[u.defId], n, r)
        }
        return i
    }
    ...
    function vr(e, t, n, o, i) {
        ...
        return s && (u.range = Pn(u.range)), o.datesDelta && n.startEditable && (u.range = {
            ...
            start: u.range.start,
            end: pr(t.allDay, u.range.start, i)
        }), t.allDay && (u.range = {
            start: rt(u.range.start),
            end: rt(u.range.end)
        }), u.range.end < u.range.start && (u.range.end = pr(t.allDay, u.range.start, i)), u
    }
    ...
    function yr(e, t, n) {
        var r;
        if (void 0 === n && (n = Er(t)), "string" == typeof e ? r = {url: e} : "function" == typeof e || Array.isArray(e) ? r = {events: e} : "object" == typeof e && e && (r = e), r) {
    ...
    function Er(e) {
        return r(r(r({}, Sn), mr), e.pluginHooks.eventSourceRefiners)
    }
    ...
    var Dr = function () {
        ...
        return e.prototype.getCurrentData = function () {
            ...
            var e = this.getCurrentData();
            this.unselect(), this.dispatch({type: "CHANGE_DATE", dateMarker: Sr(e.calendarOptions.now, e.dateEnv)})
            ...
            var r = this.getCurrentData(), o = ir(n, r.dateEnv, kt({days: 1}));
            o && (this.dispatch({type: "SELECT_DATES", selection: o}), cr(o, null, r))
            ...
            var s = kn(e, o, i, !1);
            if (s) {
                var l = new br(i, s.def, s.def.recurringDef ? null : s.instance);
            ...
            this.getCurrentData().emitter.trigger("eventAdd", {
                event: e, relatedEvents: [], revert: function () {
                    t.dispatch({type: "REMOVE_EVENTS", eventStore: Cr(e)})
                }
            })
            ...
            for (var i in e = String(e), r) {
                var a = r[i];
                if (a.publicId === e) {
                    if (a.recurringDef) return new br(t, a, null);
                    for (var s in o) {
                        var l = o[s];
                        if (l.defId === a.defId) return new br(t, a, l)
                    }
                }
            }
            return null
        ...
        return e.prototype.setProp = function (e, t) {
            var n, r;
            if (e in _n) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead."); else if ("id" === e) t = Rn[e](t), this.mutate({standardProps: {publicId: t}}); else if (e in Rn) t = Rn[e](t), this.mutate({standardProps: (n = {}, n[e] = t, n)}); else if (e in Sn) {
                var o = Sn[e](t);
            ...
            if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
                ...
                !0 === n.allDay && (u = Pn(u));
                var c = On(u.start, l, a, n.granularity);
                if (r) {
                    var d = On(u.end, r, a, n.granularity);
    ...
    function wr(e, t, n) {
        ...
        for (var s in o) {
            ...
            l.instanceId !== a && i.push(new br(t, u, l))
        }
        return i
    }

    var Rr, _r = {}, Tr = function () {
        function e() {
        }
    ...
    function Nr(e) {
        for (var t = e.length > 0 ? e[0].code : "en", n = Ir.concat(e), r = {en: Pr}, o = 0, i = n; o < i.length; o++) {
            var a = i[o];
            r[a.code] = a
        }
    ...
    function Hr(e, t) {
        return "object" != typeof e || Array.isArray(e) ? function (e, t) {
            ...
            return Or(e, n, r)
        }(e, t) : Or(e.code, [e.code], e)
    }

    function Or(e, t, n) {
        var r = ht([Pr, n], ["buttonText"]);
        delete r.code;
        var o = r.week;
    ...
    function Ar(e) {
        var t = Hr(e.locale || "en", Nr([]).map);
        return new Mr(r(r({timeZone: on.timeZone, calendarSystem: "gregory"}, e), {locale: t}))
    }
    ...
    var qr = {defs: {}, instances: {}}, Yr = function () {
        function e() {
        ...
        return e.prototype.splitProps = function (e) {
            ...
            for (var c in this.eventUiBuilders = gt(n, (function (e, n) {
                return t.eventUiBuilders[n] || Ft(Zr)
            })), n) {
                var d = n[c], p = a[c] || qr, f = this.eventUiBuilders[c];
                u[c] = {
            ...
            for (var i in n) for (var a = 0, s = t[i]; a < s.length; a++) o[p = s[a]] || (o[p] = {
                defs: {},
                instances: {}
            }), o[p].defs[i] = n[i];
            ...
            if (e) {
                var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
                    ...
                    i = function (r) {
                        t[r] || (t[r] = {affectedEvents: n[r] || qr, mutatedEvents: o[r] || qr, isEvent: e.isEvent})
                    };
                for (var a in n) i(a);
                for (var a in o) i(a)
            }
    ...
    function ro(e, t) {
        ...
        var n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            a = parseInt(n.borderBottomWidth, 10) || 0, s = no(e), l = s.y - r - o, u = {
                borderLeft: r,
                borderRight: o,
                borderTop: i,
                borderBottom: a,
    ...
    function oo(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : io(e), o = ro(e, t), i = {
    ...
    if (ho.prototype.classes = {}, ho.prototype.iconClasses = {}, ho.prototype.baseIconClass = "", ho.prototype.iconOverridePrefix = "", "undefined" == typeof FullCalendarVDom) throw new Error("Please import the top-level fullcalendar lib before attempting to import a plugin.");
    var vo = FullCalendarVDom.Component, go = FullCalendarVDom.createElement, mo = FullCalendarVDom.render,
        yo = FullCalendarVDom.createRef, Eo = FullCalendarVDom.Fragment, So = FullCalendarVDom.createContext,
        Do = FullCalendarVDom.createPortal, bo = FullCalendarVDom.flushToDom,
        Co = FullCalendarVDom.unmountComponentAtNode, wo = function () {
            function e(e, t, n, o) {
                var i = this;
    ...
    function _o(e, t, n, r, o, i, a, s, l, u, c, d, p) {
        return {
            dateEnv: o,
            options: n,
            pluginHooks: a,
            ...
            createScrollResponder: function (e) {
                return new wo(e, u, kt(n.scrollTime), n.scrollTimeReset)
            },
    ...
    var To = function (e) {
        ...
        }, t.addPropsEquality = xo, t.addStateEquality = Mo, t.contextType = Ro, t
    }(vo);
    ...
    var ko = function (e) {
        ...
        return n(t, e), t.contextType = Ro, t
    }(To);
    ...
    var Ao = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.rootElRef = yo(), t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(Vo, {
                ...
                return go(Lo, {
                    ...
                    return t.children(r, zo(t.classNames, n), e, o)
                }))
            }))
        }, t
    }(ko), Uo = So(0);
    ...
    function Lo(e) {
        return go(Uo.Consumer, null, (function (t) {
            return go(Wo, r({renderId: t}, e))
        }))
    }
    ...
    var Wo = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.context.pluginHooks.contentTypeHandlers, t = this.props, n = this.customContentInfo,
                o = Bo(t.content, t.hookProps), i = null;
            if (void 0 === o && (o = Bo(t.defaultContent, t.hookProps)), void 0 !== o) {
    ...
    function Fo() {
        var e, t, n = [];
        return function (r, o) {
            return t && Et(t, o) && r === e || (e = r, t = o, n = zo(r, o)), n
        }
    }

    function zo(e, t) {
        return "function" == typeof e && (e = e(t)), En(e)
    }

    function Bo(e, t) {
        return "function" == typeof e ? e(t, go) : e
    }
    ...
    function qo(e) {
        ...
        return n.content && (t = n, o = function (e) {
            return go(Ro.Consumer, null, (function (n) {
                return go(jo, {viewSpec: n.viewSpec}, (function (o, i) {
                    ...
                    return go(Ao, {
                        ...
                        return go("div", {className: i.concat(t).join(" "), ref: e}, r)
                    }))
                }))
            }))
        ...
        return gt(function (e, t) {
            ...
            return function (e, t, n, o, i) {
                var a = e.overrides.duration || e.defaults.duration || o.duration || n.duration, s = null, l = "",
                    u = "", c = {};
                if (a && (s = function (e) {
                    var t = JSON.stringify(e), n = Zo[t];
                    return void 0 === n && (n = kt(e), Zo[t] = n), n
                }(a))) {
                    var d = Ot(s);
    ...
    var Zo = {}, Xo = function () {
        ...
        return e.prototype.buildPrev = function (e, t, n) {
            ...
            return r = this.buildValidRange(), r = this.trimHiddenDays(r), n && (u = e, e = null != (c = r).start && u < c.start ? c.start : null != c.end && u >= c.end ? new Date(c.end.valueOf() - 1) : u), o = this.buildCurrentRangeInfo(e, t), i = /^(year|month|week|day)$/.test(o.unit), a = this.buildRenderRange(this.trimHiddenDays(o.range), o.unit, i), s = a = this.trimHiddenDays(a), d.showNonCurrentDates || (s = Ln(s, o.range)), s = Ln(s = this.adjustActiveRange(s), r), l = Vn(o.range, r), {
                validRange: r,
            ...
            var t;
            return this.props.dateIncrement || ((t = this.props.dateAlignment) ? kt(1, t) : e || kt({days: 1}))
    ...
    function $o(e, t, n, o) {
        ...
        return n && (i = Jo(i, n, o)), r(r({}, e), i)
    }

    function Jo(e, t, n) {
        return Qo(e, vt(e, (function (e) {
            return function (e, t, n) {
                return ni(e, n) ? !n.options.lazyFetching || !e.fetchRange || e.isFetching || t.start < e.fetchRange.start || t.end > e.fetchRange.end : !e.latestFetchId
            }(e, t, n)
        })), t, !1, n)
    }
    ...
    function ui(e, t, n, r, o) {
        var i = [];
        return {
            headerToolbar: e.headerToolbar ? ci(e.headerToolbar, e, t, n, r, o, i) : null,
            footerToolbar: e.footerToolbar ? ci(e.footerToolbar, e, t, n, r, o, i) : null,
            viewsWithButtons: i
        }
    }
    ...
    var hi = [No({
        ...
        eventSourceDefs: [{
            parseMeta: function (e) {
                ...
                so(e.eventSource.meta.bind(null, sr(e.range, r)), (function (e) {
                    t({rawEvents: e})
                }), n)
            }
        }]
        ...
        eventSourceRefiners: {
            ...
            parseMeta: function (e) {
                ...
                di(o.method, o.url, i, (function (e, n) {
                    t({rawEvents: e, xhr: n})
                }), (function (e, t) {
                    n({message: e, xhr: t})
                }))
        ...
        recurringTypes: [{
            parse: function (e, t) {
                ...
                var r = Ln(t, {start: e.startRecur, end: e.endRecur});
                return r ? function (e, t, n, r) {
                    for (var o = e ? mt(e) : null, i = rt(n.start), a = n.end, s = []; i < a;) {
                        var l = void 0;
        ...
        isLoadingFuncs: [function (e) {
            ...
            dateProfile: function (e, t) {
                t.emitter.trigger("datesSet", r(r({}, sr(e.activeRange, t.dateEnv)), {view: t.viewApi}))
    ...
    var Si = function () {
        function e(e) {
            var t = this;
            this.computeOptionsData = Ft(this._computeOptionsData), this.computeCurrentViewData = Ft(this._computeCurrentViewData), this.organizeRawLocales = Ft(Nr), this.buildLocale = Ft(Hr), this.buildPluginHooks = function () {
                var e, t = [], n = [];
                return function (o, i) {
            ...
            var s, l, u,
                c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : Sr(s.now, l)),
            ...
            for (var v = function (e, t, n) {
                ...
                return $o({}, function (e, t) {
                    var n = Er(t), r = [].concat(e.eventSources || []), o = [];
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            var t = this, n = t.props, o = t.state, i = t.emitter, a = function (e, t) {
                ...
                l = function (e, t) {
                    if ("CHANGE_VIEW_TYPE" === t.type) e = t.viewType;
                    return e
            ...
            this.data && this.data.dateProfileGenerator !== u.dateProfileGenerator && (p = u.dateProfileGenerator.build(d)), p = function (e, t, n, r) {
                ...
                switch (t.type) {
                    ...
                    case "CHANGE_DATE":
                        if (!e.activeRange || !zn(e.currentRange, t.dateMarker)) return r.build(t.dateMarker);
                        break;
                    case "PREV":
            ...
            }(d, e), u.dateProfileGenerator), zn(p.currentRange, d) || (d = p.currentRange.start);
            for (var f = function (e, t, n, o) {
                var i, a, s = n ? n.activeRange : null;
                switch (t.type) {
                    case "ADD_EVENT_SOURCES":
                        return $o(e, t.sources, s, o);
                    ...
                    case "FETCH_EVENT_SOURCES":
                        return Qo(e, t.sourceIds ? mt(t.sourceIds) : ti(e, o), s, t.isRefetch || !1, o);
                    case "RECEIVE_EVENTS":
                        ...
                        return function (e, t, n, r, o, i) {
                            if (t && n === t.latestFetchId) {
                                var a = hn(function (e, t, n) {
                                    ...
                                    return o && (e = ri(e, o)), r && (e = ri(e, r)), e
                                }(o, t, i), t, i);
                                return r && (a = wt(a, r, i)), mn(oi(e, t.sourceId), a)
                            }
                            return e
                        }(e, n[t.sourceId], t.fetchId, t.fetchRange, t.rawEvents, o);
                    case "ADD_EVENTS":
                        return function (e, t, n, r) {
                            return n && (t = wt(t, n, r)), mn(e, t)
            ...
            }(o.eventStore, e, f, p, c), v = Ko(f) && !u.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(c), m = g.eventUiSingleBase, y = g.selectionConfig, E = this.buildEventUiBySource(f), S = {
                ...
                eventSelection: ai(o.eventSelection, e),
                eventDrag: si(o.eventDrag, e),
                eventResize: li(o.eventResize, e)
            }, D = r(r({}, c), S), b = 0, C = s.pluginHooks.reducers; b < C.length; b++) {
                var w = C[b];
                r(S, w(o, e, D))
            }
            var R = ki(o, c), _ = ki(S, c);
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props, d = this.state, p = this.data,
                ...
                y = f.calendarOptions;
            if (m && m !== y) for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, l = v, u = (s = d.dateProfile) ? s.activeRange : null, Qo(a, ti(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = gt(e.instances, (function (e) {
                var i = o[e.defId];
            ...
            var n = dn([on, e, t]), o = n.locales, i = n.locale, a = this.organizeRawLocales(o), s = a.map,
                l = this.buildLocale(i || a.defaultCode, s).options, u = this.buildPluginHooks(e.plugins || [], hi),
    ...
    function Di(e, t, n, r, o, i, a, s) {
        var l = Hr(t || a.defaultCode, a.map);
        return new Mr({
    ...
    function Ci(e) {
        return new (e.dateProfileGeneratorClass || Xo)(e)
    }
    ...
    var Ii = function (e) {
        ...
        return e.prototype.addSegs = function (e) {
            ...
            var n = t.nextLevel;
            !n || this.levelCoords[n - 1] < t.levelCoord ? (Ai(this.levelCoords, n, t.levelCoord), Ai(this.entriesByLevel, n, [e])) : Ai(this.entriesByLevel[n - 1], t.lateralEnd, e), this.stackCnts[Hi(e)] = t.stackCnt
            ...
            for (t = 0; t < l && (n = o[t], s || !(n >= d + e.thickness)); t += 1) {
                var f = i[t], h = void 0, v = Ui(f, e.spanStart, Ni);
    ...
    }(), Bi = {}, ji = {startTime: kt, duration: kt, create: Boolean, sourceId: String};

    function Gi(e) {
        var t = pn(e, ji), n = t.refined, r = t.extra;
        return {
    ...
    var qi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go.apply(void 0, o(["div", {className: "fc-toolbar-chunk"}], t))
            ...
            for (var t = this.props, n = this.context.theme, i = [], a = !0, s = 0, l = e; s < l.length; s++) {
                ...
                if ("title" === c) a = !1, i.push(go("h2", {className: "fc-toolbar-title"}, t.title)); else {
                    ...
                    i.push(go("button", r({
                        ...
                        onClick: d,
                        type: "button"
                    }, h), p || (f ? go("span", {className: f}) : "")))
                }
            }
            if (i.length > 1) {
                var m = a && n.getClass("buttonGroup") || "";
                return go.apply(void 0, o(["div", {className: m}], i))
            }
            return i[0]
        }, t
    }(ko), Yi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return r.left ? (i = !0, e = r.left) : e = r.start, r.right ? (i = !0, t = r.right) : t = r.end, go("div", {className: [o || "", "fc-toolbar", i ? "fc-toolbar-ltr" : ""].join(" ")}, this.renderSection("start", e || []), this.renderSection("center", a || []), this.renderSection("end", t || []))
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.state, n = e.aspectRatio,
                ...
                o = "", i = "";
            return n ? null !== t.availableWidth ? o = t.availableWidth / n : i = 1 / n * 100 + "%" : o = e.height || "", go("div", {
                ref: this.handleEl,
                onClick: e.onClick,
                className: r.join(" "),
        ...
        function t(t) {
            ...
            return n.handleSegClick = function (e, t) {
                var r = n.component, o = r.context, i = qn(t);
                if (i && r.isValidSegDownEl(e.target)) {
                    ...
                    o.emitter.trigger("eventClick", {
                        el: t,
                        event: new br(r.context, i.eventRange.def, i.eventRange.instance),
                        jsEvent: e,
                        view: o.viewApi
        ...
        function t(t) {
            ...
            return a.handleEventElRemove = function (e) {
                ...
                qn(t) && (a.currentSegEl = t, a.triggerEvent("eventMouseEnter", e, t))
            }, a.handleSegLeave = function (e, t) {
                a.currentSegEl && (a.currentSegEl = null, a.triggerEvent("eventMouseLeave", e, t))
            }, a.removeHoverListeners = (n = t.el, ".fc-event", r = a.handleSegEnter, o = a.handleSegLeave, xe(n, "mouseover", ".fc-event", (function (e, t) {
                if (t !== i) {
                    i = t, r(e, t);
                    var n = function (e) {
        ...
        return n(t, e), t.prototype.destroy = function () {
            ...
            var r = this.component, o = r.context, i = qn(n);
            t && !r.isValidSegDownEl(t.target) || o.emitter.trigger(e, {
                el: n,
                event: new br(o, i.eventRange.def, i.eventRange.instance),
                jsEvent: t,
                view: o.viewApi
            })
        }, t
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildViewContext = Ft(_o), t.buildViewPropTransformers = Ft(Qi), t.buildToolbarProps = Ft(Ji), t.handleNavLinkClick = ke("a[data-navlink]", t._handleNavLinkClick.bind(t)), t.headerRef = yo(), t.footerRef = yo(), t.interactionsStore = {}, t.registerInteractiveComponent = function (e, n) {
                var r = Wi(e, n), o = [Xi, Ki].concat(t.props.pluginHooks.componentInteractions).map((function (e) {
                    return new e(r)
                }));
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(Ro.Provider, {value: l}, n.headerToolbar && go(Yi, r({
                ref: this.headerRef,
            ...
            }, this.renderView(t), this.buildAppendContent()), n.footerToolbar && go(Yi, r({
                ref: this.footerRef,
    ...
    var ea = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Gr() || i.push("fc-liquid-hack"), e.children(i, o, r, n)
        }, t.prototype.componentDidMount = function () {
    ...
    var oa = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.dateEnv, n = e.options, o = e.theme, i = e.viewApi, a = this.props, s = a.date,
                l = a.dateProfile, u = Xr(s, a.todayRange, null, l), c = [na].concat(Kr(u, o)),
                d = t.format(s, a.dayHeaderFormat),
                p = n.navLinks && !u.isDisabled && a.colCnt > 1 ? {"data-navlink": $r(s), tabIndex: 0} : {},
            ...
            return go(Ao, {
                ...
                return go("th", r({
                    ...
                    colSpan: a.colSpan
                }, a.extraDataAttrs), go("div", {className: "fc-scrollgrid-sync-inner"}, !u.isDisabled && go("a", r({
                    ref: n,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.dateEnv, o = t.theme, i = t.viewApi, a = t.options,
                ...
                u = [na].concat(Kr(l, o), e.extraClassNames || []), c = n.format(s, e.dayHeaderFormat),
            ...
            return go(Ao, {
                ...
                return go("th", r({
                    ...
                    colSpan: e.colSpan
                }, e.extraDataAttrs), go("div", {className: "fc-scrollgrid-sync-inner"}, go("a", {
        ...
        function t(t, n) {
            ...
            return r.initialNowDate = Sr(n.options.now, n.dateEnv), r.initialNowQueriedMs = (new Date).valueOf(), r.state = r.computeTiming().currentState, r
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return i = Math.min(864e5, i), {
                currentState: {nowDate: r, todayRange: sa(r)},
                nextState: {nowDate: o, todayRange: sa(o)},
                waitMs: i
            }
    ...
    var la = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.createDayHeaderFormatter = Ft(ua), t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(aa, {unit: "day"}, (function (e, t) {
                return go("tr", null, i && i("day"), n.map((function (e) {
                    return o ? go(oa, {
                        key: e.toISOString(),
                        date: e,
                        dateProfile: r,
                        ...
                        colCnt: n.length,
                        dayHeaderFormat: a
                    }) : go(ia, {key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a})
                })))
            }))
        }, t
    }(ko);
    ...
    var ca = function () {
        ...
        return e.prototype.sliceProps = function (e, t, n, r) {
            ...
            for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
            return e ? this._sliceEventStore.apply(this, o([wt(e, fa(t, Boolean(n)), r), {}, t, n], i)).bg : []
        }, e.prototype._sliceEventStore = function (e, t, n, r) {
            for (var o = [], i = 4; i < arguments.length; i++) o[i - 4] = arguments[i];
            if (e) {
                var a = Bn(e, t, fa(n, Boolean(r)), r);
            ...
            for (var o = [], i = 4; i < arguments.length; i++) o[i - 4] = arguments[i];
            if (!e) return null;
            var a = Bn(e.mutatedEvents, t, fa(n, Boolean(r)), r);
            return {
            ...
            if (!e) return [];
            for (var a = ur(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s; l < u.length; l++) {
                var c = u[l];
                c.eventRange = a
            }
            return s
    ...
    function ha(e, t, n) {
        ...
        for (var o in r) if (!Fn(t.validRange, r[o].range)) return !1;
        return ga({eventDrag: e}, n)
    }

    function va(e, t, n) {
        return !!Fn(t.validRange, e.range) && ga({dateSelection: e}, n)
    }
    ...
    function ga(e, t) {
        ...
        return (t.pluginHooks.isPropsValid || ma)(o, t)
    }
    ...
    function ma(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, o) {
            var i = t.getCurrentData(), a = e.eventDrag, s = a.mutatedEvents, l = s.defs, u = s.instances,
                c = Yn(l, a.isEvent ? e.eventUiBases : {"": i.selectionConfig});
            o && (c = gt(c, o));
            var d, p, f = (d = e.eventStore, p = a.affectedEvents.instances, {
                defs: d.defs,
                instances: vt(d.instances, (function (e) {
                    return !p[e.instanceId]
                }))
            }), h = f.defs, v = f.instances, g = Yn(h, e.eventUiBases);
            for (var m in u) {
                var y = u[m], E = y.range, S = c[y.defId], D = l[y.defId];
                if (!ya(S.constraints, E, f, e.businessHours, t)) return !1;
                ...
                for (var w in v) {
                    ...
                    if (Vn(E, R.range)) {
                        ...
                        if (C && !C(new br(t, h[R.defId], R), new br(t, D, y))) return !1
                    }
                }
                for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
                    var x, M = k[T], I = r(r({}, n), {range: y.range, allDay: D.allDay}), P = _.defs[D.defId],
                        N = _.instances[m];
                    if (x = P ? new br(t, P, N) : new br(t, D), !M(dr(I, t), x)) return !1
                }
            }
            return !0
            ...
            if (o && (c = o(c)), !ya(c.constraints, u, i, e.businessHours, t)) return !1;
            var d = t.options.selectOverlap, p = "function" == typeof d ? d : null;
            for (var f in s) {
                var h = s[f];
                if (Vn(u, h.range)) {
                    if (!1 === c.overlap) return !1;
                    if (p && !p(new br(t, a[h.defId], h), null)) return !1
                }
            }
            for (var v = 0, g = c.allows; v < g.length; v++) if (!(0, g[v])(dr(r(r({}, n), l), t), null)) return !1;
            return !0
        }(e, t, n, o))
    }

    function ya(e, t, n, r, o) {
        for (var i = 0, a = e; i < a.length; i++) if (!Da(Ea(a[i], t, n, r, o), t)) return !1;
        return !0
    }

    function Ea(e, t, n, r, o) {
        return "businessHours" === e ? Sa(wt(r, t, o)) : "string" == typeof e ? Sa(yn(n, (function (t) {
            return t.groupId === e
        }))) : "object" == typeof e && e ? Sa(wt(e, t, o)) : []
    }
    ...
    function Da(e, t) {
        for (var n = 0, r = e; n < r.length; n++) if (Fn(r[n], t)) return !0;
        return !1
    }

    var ba = /^(visible|hidden)$/, Ca = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return t && (n ? o.push("fc-scroller-liquid-absolute") : o.push("fc-scroller-liquid")), go("div", {
                ref: this.handleEl,
                className: o.join(" "),
                style: {
            ...
            return ba.test(this.props.overflowX) ? 0 : this.el.offsetHeight - this.el.clientHeight
        }, t.prototype.getYScrollbarWidth = function () {
            return ba.test(this.props.overflowY) ? 0 : this.el.offsetWidth - this.el.clientWidth
        }, t
    }(ko), wa = function () {
        function e(e) {
            var t = this;
    ...
    function Ta(e, t) {
        return null != t.maxHeight || _a(e, t)
    }

    function ka(e, t, n) {
        var r = n.expandRows;
        return "function" == typeof t.content ? t.content(n) : go("table", {
        ...
        }, n.tableColGroupNode, go("tbody", {}, "function" == typeof t.rowContent ? t.rowContent(n) : t.rowContent))
    }
    ...
    function Ma(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++) for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(go("col", {
            style: {
                width: "shrink" === a.width ? Ia(t) : a.width || "",
                minWidth: a.minWidth || ""
            }
        }));
        return go.apply(void 0, o(["colgroup", {}], n))
    }
    ...
    var La = function (e) {
        function t() {
            ...
            return t.processCols = Ft((function (e) {
                return e
            }), xa), t.renderMicroColGroup = Ft(Ma), t.scrollerRefs = new wa, t.scrollerElRefs = new wa(t._handleScrollerEl.bind(t)), t.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = e.props, n = e.state, r = e.context, i = t.sections || [], a = this.processCols(t.cols),
                s = this.renderMicroColGroup(a, n.shrinkWidth), l = Na(t.liquid, r);
            ...
            }, Boolean(!v && p.length) && go.apply(void 0, o(["thead", {}], p)), Boolean(!v && f.length) && go.apply(void 0, o(["tbody", {}], f)), Boolean(!v && h.length) && go.apply(void 0, o(["tfoot", {}], h)), v && go.apply(void 0, o(o(o(["tbody", {}], p), f), h)))
        }, t.prototype.renderSection = function (e, t) {
            return "outerContent" in e ? go(Eo, {key: e.key}, e.outerContent) : go("tr", {
                key: e.key,
                className: Ha(e, this.props.liquid).join(" ")
            ...
            var r = this.props, o = this.state, i = o.forceYScrollbars, a = o.scrollerClientWidths,
                s = o.scrollerClientHeights, l = Ta(r, e), u = _a(r, e),
                c = r.liquid ? i ? "scroll" : l ? "auto" : "hidden" : "visible", d = e.key, p = ka(e, n, {
                    tableColGroupNode: t,
                    tableMinWidth: "",
            ...
            return go("td", {ref: n.elRef}, go("div", {className: "fc-scroller-harness" + (u ? " fc-scroller-harness-liquid" : "")}, go(Ca, {
            ...
            return Pa(this.props.cols) ? Ra(this.scrollerElRefs.getAll()) : 0
        }, t.prototype.computeScrollerDims = function () {
            var e = to(), t = this.scrollerRefs, n = this.scrollerElRefs, r = !1, o = {}, i = {};
    ...
    La.addStateEquality({scrollerClientWidths: Et, scrollerClientHeights: Et});
    var Wa = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.elRef = yo(), t
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = e.seg, o = r.eventRange, i = o.ui, a = {
                event: new br(t, o.def, o.instance),
                view: t.viewApi,
                timeText: e.timeText,
                textColor: i.textColor,
                backgroundColor: i.backgroundColor,
                borderColor: i.borderColor,
                isDraggable: !e.disableDragging && $n(r, t),
                isStartResizable: !e.disableResizing && Jn(r, t),
                isEndResizable: !e.disableResizing && Qn(r),
            ...
            Gn(this.elRef.current, this.props.seg)
        }, t.prototype.componentDidUpdate = function (e) {
            var t = this.props.seg;
            t !== e.seg && Gn(this.elRef.current, t)
        }, t
    }(ko), Va = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = e.seg, o = t.options.eventTimeFormat || e.defaultTimeFormat,
                i = er(n, o, t, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
            return go(Wa, {
                seg: n,
                timeText: i,
                disableDragging: e.disableDragging,
                disableResizing: e.disableResizing,
                defaultContent: e.defaultContent || Fa,
                ...
                }, a), s.isStartResizable && go("div", {className: "fc-event-resizer fc-event-resizer-start"}), s.isEndResizable && go("div", {className: "fc-event-resizer fc-event-resizer-end"}))
            }))
        }, t
    }(ko);

    function Fa(e) {
        return go("div", {className: "fc-event-main-frame"}, e.timeText && go("div", {className: "fc-event-time"}, e.timeText), go("div", {className: "fc-event-title-container"}, go("div", {className: "fc-event-title fc-sticky"}, e.event.title || go(Eo, null, " "))))
    }

    var za = function (e) {
        return go(Ro.Consumer, null, (function (t) {
    ...
    }, Ba = nn({day: "numeric"}), ja = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = Ga({
                date: e.date,
                dateProfile: e.dateProfile,
            ...
            return go(Lo, {hookProps: r, content: n.dayCellContent, defaultContent: e.defaultContent}, e.children)
        }, t
    }(ko);

    function Ga(e) {
        var t = e.date, n = e.dateEnv, o = Xr(t, e.todayRange, null, e.dateProfile);
        return r(r(r({
            date: n.toDate(t),
            view: e.viewApi
        }, o), {dayNumberText: e.showDayNumber ? n.format(t, Ba) : ""}), e.extraProps)
    }

    var qa = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = zt(Ga), t.normalizeClassNames = Fo(), t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = this.refineHookProps({
                    ...
                    viewApi: t.viewApi,
                    dateEnv: t.dateEnv
                }), o = Kr(r, t.theme).concat(r.isDisabled ? [] : this.normalizeClassNames(n.dayCellClassNames, r)),
    ...
    function Xa(e) {
        return e.event.title && go("div", {className: "fc-event-title"}, e.event.title)
    }
    ...
    var Ja = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Do(go("div", r({className: n.join(" ")}, t.extraAttrs, {ref: this.handleRootEl}), go("div", {className: "fc-popover-header " + e.getClass("popoverHeader")}, go("span", {className: "fc-popover-title"}, t.title), go("span", {
                className: "fc-popover-close " + e.getIconClass("close"),
                onClick: this.handleCloseClick
            })), go("div", {className: "fc-popover-body " + e.getClass("popoverContent")}, t.children)), t.parentEl)
        }, t.prototype.componentDidMount = function () {
            ...
            var e = this.context.isRtl, t = this.props, n = t.alignmentEl, r = t.alignGridTop, o = this.rootEl,
                i = function (e) {
                    for (var t = ao(e), n = e.getBoundingClientRect(), r = 0, o = t; r < o.length; r++) {
                        var i = Fr(n, o[r].getBoundingClientRect());
                        if (!i) return null;
                        n = i
                    }
                    return n
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(qa, {date: o, dateProfile: a, todayRange: i, elRef: this.handleRootEl}, (function (e, t, n) {
                return go(Ja, {
                    elRef: e,
                    title: s,
                    ...
                    onClose: r.onClose
                }, go(ja, {date: o, dateProfile: a, todayRange: i}, (function (e, t) {
                    return t && go("div", {className: "fc-more-popover-misc", ref: e}, t)
                })), r.children)
            }))
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.linkElRef = yo(), t.state = {isPopoverOpen: !1}, t.handleClick = function (e) {
                var n = t, r = n.props, o = n.context, i = o.options.moreLinkClick, a = ns(r).start;
    ...
    function ns(e) {
        ...
        return {start: rs(n), end: (t = n, t.reduce(is).eventRange.range.end)}
    }

    function rs(e) {
        return e.reduce(os).eventRange.range.start
    }
    ...
    var as = function (e) {
        function t(t, n) {
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    o.isRendered = !0;
                    var e = o.currentData;
                    mo(go(ea, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, (function (t, n, i, a) {
                        return o.setClassNames(t), o.setHeight(n), go(Uo.Provider, {value: o.customContentRenderId}, go($i, r({
                            isHeightAuto: i,
                            forPrint: a
                        }, e)))
                    })), o.el)
                } else o.isRendered && (o.isRendered = !1, Co(o.el), o.setClassNames([]), o.setHeight(""));
                bo()
            }, o.el = t, o.renderRunner = new mi(o.handleRenderRequest), new Si({
                optionOverrides: n,
                calendarApi: o,
        ...
        return n(t, e), Object.defineProperty(t.prototype, "view", {
            ...
            e.prototype.updateSize.call(this), bo()
    ...
    Bi.touchMouseIgnoreWait = 500;
    var ss = 0, ls = 0, us = !1, cs = function () {
        function e(e) {
            var t = this;
            ...
            }, this.containerEl = e, this.emitter = new lo, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {passive: !0}), 1 === (ls += 1) && window.addEventListener("touchmove", ds, {passive: !1})
        }

        return e.prototype.destroy = function () {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {passive: !0}), (ls -= 1) || window.removeEventListener("touchmove", ds, {passive: !1})
    ...
    var ps = function () {
        ...
        return n(t, e), t.prototype.getEventTarget = function () {
            ...
            return oo(this.scrollController.el)
        }, t
    }(fs), vs = function (e) {
        function t(t) {
            return e.call(this, new fo, t) || this
        }
    ...
    }(fs), gs = "function" == typeof performance ? performance.now : Date.now, ms = function () {
        function e() {
            var e = this;
        ...
        return e.prototype.start = function (e, t) {
            ...
            if (this.isEnabled) {
                ...
                o < 0 ? this.everMovedUp = !0 : o > 0 && (this.everMovedDown = !0), i < 0 ? this.everMovedLeft = !0 : i > 0 && (this.everMovedRight = !0), this.pointerScreenX = n, this.pointerScreenY = r, this.isAnimating || (this.isAnimating = !0, this.requestAnimation(gs()))
            }
            ...
            return this.queryScrollEls().map((function (e) {
                return e === window ? new vs(!1) : new hs(e, !1)
            }))
        ...
        function t(t, n) {
            ...
            var o = r.pointer = new cs(t);
            return o.emitter.on("pointerdown", r.onPointerDown), o.emitter.on("pointermove", r.onPointerMove), o.emitter.on("pointerup", r.onPointerUp), n && (o.selector = n), r.mirror = new ps, r.autoScroller = new ms, r
        }
        ...
        function e(e) {
            this.origRect = io(e), this.scrollCaches = ao(e).map((function (e) {
                return new hs(e, !0)
            }))
        }
        ...
        return e.prototype.destroy = function () {
            ...
            for (var n, r = {left: e, top: t}, o = 0, i = this.scrollCaches; o < i.length; o++) {
                var a = i[o];
                if (void 0, "HTML" !== (n = a.getEventTarget().tagName) && "BODY" !== n && !Vr(r, a.clientRect)) return !1
            }
            return !0
        }, e
    }(), Ss = function () {
        function e(e, t) {
            ...
            }, this.droppableStore = t, e.emitter.on("pointerdown", this.handlePointerDown), e.emitter.on("dragstart", this.handleDragStart), e.emitter.on("dragmove", this.handleDragMove), e.emitter.on("pointerup", this.handlePointerUp), e.emitter.on("dragend", this.handleDragEnd), this.dragging = e, this.emitter = new lo
        }

        return e.prototype.processFirstCoord = function (e) {
            var t, n = {left: e.pageX, top: e.pageY}, r = n, o = e.subjectEl;
            o !== document && (r = zr(r, t = io(o)));
            ...
            !t && Ds(this.movingHit, n) || (this.movingHit = n, this.emitter.trigger("hitupdate", n, !1, e))
        }, e.prototype.prepareHits = function () {
            this.offsetTrackers = gt(this.droppableStore, (function (e) {
                return e.component.prepareHits(), new Es(e.el)
            }))
            ...
            for (var i in n) {
                ...
                if (s && s.isWithinClipping(e, t)) {
                    ...
                    if (c >= 0 && c < f && d >= 0 && d < h) {
                        ...
                        v && Fn(v.dateProfile.activeRange, v.dateSpan.range) && (!o || v.layer > o.layer) && (v.componentId = i, v.context = a.context, v.rect.left += l, v.rect.right += l, v.rect.top += u, v.rect.bottom += u, o = v)
                    }
                }
            }
            return o
    ...
    function Ds(e, t) {
        return !e && !t || Boolean(e) === Boolean(t) && ar(e.dateSpan, t.dateSpan)
    }
    ...
    var Cs = function (e) {
        function t(t) {
            ...
            n.handlePointerDown = function (e) {
                ...
                if (!n.dragging.pointer.wasTouchScroll) {
                    ...
                    if (i && a && Ds(i, a)) {
                        var s = t.context, l = r(r({}, bs(i.dateSpan, s)), {
                            dayEl: i.dayEl,
                            jsEvent: e.origEvent,
            ...
            }, n.dragging = new ys(t.el), n.dragging.autoScroller.isEnabled = !1;
            var o = n.hitDragging = new Ss(n.dragging, Vi(t));
        ...
        function t(t) {
            ...
            n.dragSelection = null, n.handlePointerDown = function (e) {
                ...
                if (e) {
                    ...
                    }(s, e, o.pluginHooks.dateSelectionTransformers)), i && va(i, e.dateProfile, o) || (a = !0, i = null)
                }
                i ? o.dispatch({
                    type: "SELECT_DATES",
                    selection: i
                ...
                n.dragSelection && (cr(n.dragSelection, e, n.component.context), n.dragSelection = null)
            };
            var o = t.component.context.options, i = n.dragging = new ys(t.el);
            i.touchScrollAllowed = !1, i.minDistance = o.selectMinDistance || 0, i.autoScroller.isEnabled = o.dragScroll;
            var a = n.hitDragging = new Ss(n.dragging, Vi(t));
        ...
        function t(n) {
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                ...
                var u = o.subjectSeg = qn(e.subjectEl), c = (o.eventRange = u.eventRange).instance.instanceId;
                ...
                e.isTouch ? r !== o.component.props.eventSelection && t.dispatch({
                    ...
                    el: o.subjectEl,
                    event: new br(t, n.def, n.instance),
                    jsEvent: e.origEvent,
                    view: t.viewApi
                }))
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        i === a || d.editable && d.droppable ? (s = function (e, t, n) {
                            ...
                            var l = On(i, a, e.context.dateEnv, e.componentId === t.componentId ? e.largeUnit : null);
                            ...
                            return u
                        }(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && (l = fr(n, a.getCurrentData().eventUiBases, s, a), c.mutatedEvents = l, ha(c, e.dateProfile, a) || (u = !0, s = null, l = null, c.mutatedEvents = {
                            defs: {},
                            instances: {}
                        })) : a = null
                    }
                    o.displayDrag(a, c), u ? He() : Oe(), t || (i === a && Ds(r, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !document.querySelector(".fc-event-mirror")), o.receivingContext = a, o.validMutation = s, o.mutatedRelevantEvents = l)
                }
                ...
                if (o.isDragging) {
                    var t = o.component.context, n = t.viewApi, i = o, a = i.receivingContext, s = i.validMutation,
                        l = o.eventRange.def, u = o.eventRange.instance, c = new br(t, l, u), d = o.relevantEvents,
                    ...
                    if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (a === t) {
                            var h = new br(t, p.defs[l.defId], u ? p.instances[u.instanceId] : null);
                            t.dispatch({type: "MERGE_EVENTS", eventStore: p});
                            for (var v = {
                                oldEvent: c, event: h, relatedEvents: wr(p, t, u), revert: function () {
                            ...
                            var S = {
                                event: c, relatedEvents: wr(d, t, u), revert: function () {
                                    t.dispatch({type: "MERGE_EVENTS", eventStore: d})
                                }
                            };
                            ...
                            var D = p.defs[l.defId], b = p.instances[u.instanceId], C = new br(a, D, b);
                            a.dispatch({type: "MERGE_EVENTS", eventStore: p});
                            var w = {
                                event: C, relatedEvents: wr(p, a, b), revert: function () {
                            ...
                            }), a.emitter.trigger("drop", r(r({}, bs(f.dateSpan, a)), {
                                draggedEl: e.subjectEl,
                                jsEvent: e.origEvent,
            ...
            var i = o.component.context.options, a = o.dragging = new ys(n.el);
            a.pointer.selector = t.SELECTOR, a.touchScrollAllowed = !1, a.autoScroller.isEnabled = i.dragScroll;
            var s = o.hitDragging = new Ss(o.dragging, Fi);
        ...
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                var t = n.component, r = qn(n.querySegEl(e)), o = n.eventRange = r.eventRange;
                ...
                n.draggingSegEl = o, n.draggingSeg = qn(o), t.calendarApi.unselect(), t.emitter.trigger("eventResizeStart", {
                    el: o,
                    event: new br(t, r.def, r.instance),
                    jsEvent: e.origEvent,
                    view: t.viewApi
                })
                ...
                e && (e.componentId === a.componentId && n.isHitComboAllowed && !n.isHitComboAllowed(a, e) || (l = function (e, t, n, r) {
                    var o = e.context.dateEnv, i = On(e.dateSpan.range.start, t.dateSpan.range.start, o, e.largeUnit);
                    if (n) {
                        if (o.add(r.start, i) < r.end) return {startDelta: i}
                    } else if (o.add(r.end, i) > r.start) return {endDelta: i};
                    return null
                }(a, e, r.subjectEl.classList.contains("fc-event-resizer-start"), s.range))), l && (u = fr(i, o.getCurrentData().eventUiBases, l, o), d.mutatedEvents = u, ha(d, e.dateProfile, o) || (c = !0, l = null, u = null, d.mutatedEvents = null)), u ? o.dispatch({
                    type: "SET_EVENT_RESIZE",
                    state: d
                }) : o.dispatch({type: "UNSET_EVENT_RESIZE"}), c ? He() : Oe(), t || (l && Ds(a, e) && (l = null), n.validMutation = l, n.mutatedRelevantEvents = u)
            }, n.handleDragEnd = function (e) {
                var t = n.component.context, o = n.eventRange.def, i = n.eventRange.instance, a = new br(t, o, i),
                ...
                if (t.emitter.trigger("eventResizeStop", {
                    ...
                    var u = new br(t, l.defs[o.defId], i ? l.instances[i.instanceId] : null);
                    t.dispatch({type: "MERGE_EVENTS", eventStore: l});
                    var c = {
                        oldEvent: a, event: u, relatedEvents: wr(l, t, i), revert: function () {
            ...
            var o = t.component, i = n.dragging = new ys(t.el);
        ...
        function e(e) {
            ...
            this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = function (e) {
                ...
                t.matchesCancel = !!Se(r, n), t.matchesEvent = !!Se(r, Rs.SELECTOR)
            ...
            var n = this.documentPointer = new cs(document);
        ...
        function e(e, t) {
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                e && (a = e.context, n.canDropElOnCalendar(o.subjectEl, a) && (s = function (e, t, n) {
                    ...
                    var l = xn(o, n),
                        u = In(l.refined, l.extra, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n),
                        c = e.range.start;
                    e.allDay && t.startTime && (c = n.dateEnv.add(c, t.startTime));
                    var d = t.duration ? n.dateEnv.add(c, t.duration) : pr(e.allDay, c, n);
                    return {def: u, instance: pt(u.defId, {start: c, end: d})}
                }(e.dateSpan, n.dragMeta, a), u.mutatedEvents = vn(s), (l = !ha(u, e.dateProfile, a)) && (u.mutatedEvents = {
                    defs: {},
                    instances: {}
                ...
                if (n.clearDrag(), o && i) {
                    ...
                    if (o.emitter.trigger("drop", r(r({}, bs(a.dateSpan, o)), {
                        draggedEl: e.subjectEl,
                        jsEvent: e.origEvent,
                        view: s
                    })), l.create) {
                        ...
                        o.dispatch({
                            ...
                            event: new br(o, i.def, i.instance),
                            relatedEvents: [],
                            revert: function () {
            ...
            var o = this.hitDragging = new Ss(e, Fi);
        ...
        return e.prototype.buildDragMeta = function (e) {
            return "object" == typeof this.suppliedDragMeta ? Gi(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? Gi(this.suppliedDragMeta(e)) : Gi((t = function (e, t) {
                var n = Bi.dataAttrPrefix, r = (n ? n + "-" : "") + "event";
                return e.getAttribute("data-" + r) || ""
            }(e)) ? JSON.parse(t) : {create: !1});
            var t
    ...
    var Is = function () {
        function e(e, t) {
            ...
            r.touchScrollAllowed = !1, null != t.itemSelector && (r.pointer.selector = t.itemSelector), null != t.appendTo && (r.mirror.parentNode = t.appendTo), r.emitter.on("pointerdown", this.handlePointerDown), r.emitter.on("dragstart", this.handleDragStart), new Ms(r, t.eventData)
        }
        ...
        function e(e, t) {
            ...
            var r = this.dragging = new Ps(n);
            "string" == typeof t.itemSelector ? r.pointer.selector = t.itemSelector : n === document && (r.pointer.selector = "[data-event]"), "string" == typeof t.mirrorSelector && (r.mirrorSelector = t.mirrorSelector), new Ms(r, t.eventData)
        }
        ...
        componentInteractions: [Cs, ws, Rs, _s],
        calendarInteractions: [Ts],
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.headerElRef = yo(), t
        }

        return n(t, e), t.prototype.renderSimpleLayout = function (e, t) {
            var n = this.props, r = this.context, o = [], i = Aa(r.options);
            return e && o.push({
                type: "header",
                key: "header",
                isSticky: i,
                ...
                liquid: !0,
                chunk: {content: t}
            }), go(jo, {viewSpec: r.viewSpec}, (function (e, t) {
                return go("div", {
                    ref: e,
            ...
            var i = this.props, a = this.context, s = !i.forPrint && Aa(a.options), l = !i.forPrint && Ua(a.options),
                u = [];
            return e && u.push({
                type: "header",
                key: "header",
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{key: "main", content: Oa}]
            }), go(jo, {viewSpec: a.viewSpec}, (function (e, t) {
                return go("div", {
                    ref: e,
                    className: ["fc-daygrid"].concat(t).join(" ")
                }, go(o, {
    ...
    var Ws = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context.options.navLinks ? {"data-navlink": $r(e.date), tabIndex: 0} : {};
            return go(ja, {
                date: e.date,
                dateProfile: e.dateProfile,
                todayRange: e.todayRange,
                ...
                return (o || e.forceDayTop) && go("div", {
                    className: "fc-daygrid-day-top",
                    ref: n
                }, go("a", r({className: "fc-daygrid-day-number"}, t), o || go(Eo, null, " ")))
            }))
        }, t
    }(ko);
    ...
    var Fs = nn({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "narrow"});
    ...
    var Bs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options.eventTimeFormat || Fs,
                o = er(e.seg, n, t, !0, e.defaultDisplayEventEnd);
            return go(Wa, {
                seg: e.seg,
                timeText: o,
                defaultContent: Gs,
                ...
                return go("a", r({
                    ...
                    ref: t
                }, (a = e.seg.eventRange.def.url) ? {href: a} : {}), i);
                var a
            }))
        }, t
    }(ko);
    ...
    function Gs(e) {
        return go(Eo, null, go("div", {
            className: "fc-daygrid-event-dot",
            style: {borderColor: e.borderColor || e.backgroundColor}
        }), e.timeText && go("div", {className: "fc-event-time"}, e.timeText), go("div", {className: "fc-event-title"}, e.event.title || go(Eo, null, " ")))
    }

    var qs = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.compileSegs = Ft(Ys), t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(es, {
                ...
                popoverContent: function () {
                    ...
                    return go(Eo, null, n.map((function (n) {
                ...
                return go("a", {ref: e, className: ["fc-daygrid-more-link"].concat(t).join(" "), onClick: o}, r)
            }))
        }, t
    }(ko);
    ...
    var Zs = nn({week: "narrow"}), Xs = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.rootElRef = yo(), t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = e.props, n = e.context, o = e.rootElRef, i = n.options, a = t.date, s = t.dateProfile,
                l = i.navLinks ? {"data-navlink": $r(a, "week"), tabIndex: 0} : {};
            return go(qa, {
                date: a,
                dateProfile: s,
                todayRange: t.todayRange,
                ...
                return go("td", r({
                ...
                }, i, t.extraDataAttrs), go("div", {
                    className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner",
                    ref: t.innerElRef
                }, t.showWeekNumber && go(Ka, {date: a, defaultFormat: Zs}, (function (e, t, n, o) {
                    return go("a", r({ref: e, className: ["fc-daygrid-week-number"].concat(t).join(" ")}, l), o)
                })), !u && go(Ws, {
                    date: a,
                    dateProfile: s,
                    showDayNumber: t.showDayNumber,
                    ...
                    todayRange: t.todayRange
                }))), go("div", {className: "fc-daygrid-day-bg"}, t.bgContent)))
            }))
        }, t
    }(Po);
    ...
    function Ks(e, t, n, o) {
        ...
        var i = e.eventRange, a = i.range, s = Ln(a, {start: o[t].date, end: Ke(o[n - 1].date, 1)});
        return r(r({}, e), {
            firstCol: t,
            lastCol: n - 1,
    ...
    var $s = function (e) {
        ...
        return n(t, e), t.prototype.addSegs = function (t) {
            ...
            if (this.hiddenConsumes && s >= 0) for (var l = t.lateralStart; l < t.lateralEnd; l += 1) {
                ...
                if (this.allowReslicing) {
                    ...
                    a[d = Hi(c)] || (a[d] = !0, i[s][l] = c, this.splitEntry(u, n, o))
                } else {
                    var d;
                    a[d = Hi(u)] || (a[d] = !0, o.push(u))
                }
            }
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.cellElRefs = new wa, t.frameElRefs = new wa, t.fgElRefs = new wa, t.segHarnessRefs = new wa, t.rootElRef = yo(), t.state = {
                framePositions: null,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this, n = t.props, r = t.state, o = t.context.options, i = n.cells.length,
                a = Us(n.businessHourSegs, i), s = Us(n.bgEventSegs, i), l = Us(this.getHighlightSegs(), i),
                u = Us(this.getMirrorSegs(), i), c = function (e, t, n, r, o, i, a) {
                    var s = new $s;
                        ...
                        for (var r = function (e, t) {
                            ...
                            for (var g = 0, m = l; g < m.length; g++) {
                                ...
                                d += y.levelCoord - c, c = y.levelCoord + y.thickness, E ? (d += y.thickness, S && v.push({
                                    seg: Ks(h, y.spanStart, y.spanEnd, n),
                                    isVisible: !0,
                                    isAbsolute: !0,
                    ...
                    for (var b = 0, C = p; b < C.length; b++) {
                        ...
                        for (v[w.spanStart].push({
                            seg: R,
                            isVisible: !1,
                            isAbsolute: !0,
                            absoluteTop: 0,
                            marginTop: 0
                        }), D = w.spanStart; D < w.spanEnd; D += 1) m[D] += 1, h[D].push({
                            seg: Ks(R, D, D + 1, a),
                            isVisible: !1,
                            isAbsolute: !1,
                            absoluteTop: 0,
                ...
                }(Xn(n.fgEventSegs, o.eventOrder), n.dayMaxEvents, n.dayMaxEventRows, o.eventOrderStrict, r.eventInstanceHeights, r.maxContentHeight, n.cells),
            ...
            return go("tr", {ref: this.rootElRef}, n.renderIntro && n.renderIntro(), n.cells.map((function (t, r) {
                ...
                return go(Xs, {
                    ...
                    fgContent: go(Eo, null, go(Eo, null, o), go(Eo, null, i)),
                    bgContent: go(Eo, null, e.renderFillSegs(l[r], "highlight"), e.renderFillSegs(a[r], "non-business"), e.renderFillSegs(s[r], "bg-event"))
                })
            })))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing(!0)
            ...
            if (c) for (var h = 0, v = t; h < v.length; h++) {
                ...
                D && (l.isRtl ? (C = 0, b = c.lefts[m.lastCol] - c.lefts[m.firstCol]) : (b = 0, C = c.rights[m.firstCol] - c.rights[m.lastCol])), f.push(go("div", {
            ...
            if (a) for (var l = 0, u = e; l < u.length; l++) {
                ...
                s.push(go("div", {
                    ...
                    style: d
                }, "bg-event" === t ? go(Za, r({seg: c}, tr(c, i))) : Ya(t)))
            }
            return go.apply(void 0, o([Eo, {}], s))
    ...
    Js.addStateEquality({eventInstanceHeights: Et});
    var Qs = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitBusinessHourSegs = Ft(As), t.splitBgEventSegs = Ft(As), t.splitFgEventSegs = Ft(As), t.splitDateSelectionSegs = Ft(As), t.splitEventDrag = Ft(Ls), t.splitEventResize = Ft(Ls), t.rowRefs = new wa, t.handleRootEl = function (e) {
                t.rootEl = e, e ? t.context.registerInteractiveComponent(t, {
                    el: e,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return f && !i && (f = !1, r = null, o = null), go("div", {
            ...
            }, go(aa, {unit: "day"}, (function (f, h) {
                return go(Eo, null, go("table", {
                    className: "fc-scrollgrid-sync-table",
                    style: {width: t.clientWidth, minWidth: t.tableMinWidth, height: i ? t.clientHeight : ""}
                }, t.colGroupNode, go("tbody", null, t.cells.map((function (i, f) {
                    return go(Js, {
            ...
            this.rowPositions = new uo(this.rootEl, this.rowRefs.collect().map((function (e) {
                return e.getCellEls()[0]
            })), !1, !0), this.colPositions = new uo(this.rootEl, this.rowRefs.currentMap[0].getCellEls(), !0, !1)
    ...
    var tl = function (e) {
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.slicer = new tl, t.tableRef = yo(), t
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context;
            return go(Qs, r({ref: this.tableRef}, this.slicer.sliceProps(e, e.dateProfile, e.nextDayThreshold, t, e.dayTableModel), {
                dateProfile: e.dateProfile,
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildDayTableModel = Ft(ol), t.headerRef = yo(), t.tableRef = yo(), t
        }

        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, r = t.dateProfileGenerator, o = this.props,
                i = this.buildDayTableModel(o.dateProfile, r), a = n.dayHeaders && go(la, {
                    ref: this.headerRef,
    ...
    var il = No({
        initialView: "dayGridMonth", views: {
            dayGrid: {
                component: rl, dateProfileGeneratorClass: function (e) {
                    function t() {
                        return null !== e && e.apply(this, arguments) || this
                    }
                    ...
                    return n(t, e), t.prototype.buildRenderRange = function (t, n, r) {
                        var o, i = this.props.dateEnv, a = e.prototype.buildRenderRange.call(this, t, n, r),
                            s = a.start, l = a.end;
                        return /^(year|month)$/.test(n) && (s = i.startOfWeek(s), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = Xe(o, 1))), this.props.monthMode && this.props.fixedWeekCount && (l = Xe(l, 6 - Math.ceil(Je(s, l)))), {
                            start: s,
                            end: l
                        }
                    }, t
    ...
    }(Yr), sl = nn({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "short"});

    function ll(e) {
        var t = ["fc-timegrid-slot", "fc-timegrid-slot-label", e.isLabeled ? "fc-scrollgrid-shrink" : "fc-timegrid-slot-minor"];
        return go(Ro.Consumer, null, (function (n) {
            if (!e.isLabeled) return go("td", {className: t.join(" "), "data-time": e.isoTimeStr});
            var r = n.dateEnv, o = n.options, i = n.viewApi,
                a = null == o.slotLabelFormat ? sl : Array.isArray(o.slotLabelFormat) ? nn(o.slotLabelFormat[0]) : nn(o.slotLabelFormat),
            ...
            return go(Ao, {
                ...
                }, go("div", {className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame"}, go("div", {
    ...
    var cl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            return this.props.slatMetas.map((function (e) {
                return go("tr", {key: e.key}, go(ll, r({}, e)))
            }))
        }, t
    }(ko), dl = nn({week: "short"}), pl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.allDaySplitter = new al, t.headerElRef = yo(), t.rootElRef = yo(), t.scrollerElRef = yo(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
                ...
                var o = t.context.options, i = t.props.dateProfile.renderRange, a = Qe(i.start, i.end),
                    s = o.navLinks && 1 === a ? {"data-navlink": $r(i.start, "week"), tabIndex: 0} : {};
                return o.weekNumbers && "day" === e ? go(Ka, {
                    date: i.start,
                    defaultFormat: dl
                }, (function (e, t, o, i) {
                    return go("th", {
                ...
                })) : go("th", {className: "fc-timegrid-axis"}, go("div", {
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
            var r = this.context, o = this.props, i = [], a = Aa(r.options);
            return e && i.push({
                type: "header",
                key: "header",
                isSticky: a,
                ...
                type: "body",
                key: "all-day-divider",
                outerContent: go("tr", {className: "fc-scrollgrid-section"}, go("td", {className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded")}))
            })), i.push({
                type: "body",
                key: "body",
                liquid: !0,
            ...
            }), go(jo, {viewSpec: r.viewSpec, elRef: this.rootElRef}, (function (e, t) {
                return go("div", {
            ...
            var u = this.context, c = this.props, d = !c.forPrint && Aa(u.options), p = !c.forPrint && Ua(u.options),
                f = [];
            e && f.push({
                type: "header",
                key: "header",
                ...
                chunks: [{
                    key: "axis", rowContent: function (e) {
                        return go("tr", null, s.renderHeadAxis("day", e.rowSyncHeights[0]))
                    }
                ...
                chunks: [{
                    key: "axis", rowContent: function (e) {
                        return go("tr", null, s.renderTableRowAxis(e.rowSyncHeights[0]))
                    }
                }, {key: "cols", content: t}]
            }), f.push({
                key: "all-day-divider",
                type: "body",
                outerContent: go("tr", {className: "fc-scrollgrid-section"}, go("td", {
                    colSpan: 2,
            ...
            return f.push({
                ...
                chunks: [{
                    key: "axis", content: function (e) {
                        return go("div", {className: "fc-timegrid-axis-chunk"}, go("table", {style: {height: e.expandRows ? e.clientHeight : ""}}, e.tableColGroupNode, go("tbody", null, go(cl, {slatMetas: i}))), go("div", {className: "fc-timegrid-now-indicator-container"}, go(aa, {unit: h ? "minute" : "day"}, (function (e) {
                            var t = h && a && a.safeComputeTop(e);
                            return "number" == typeof t ? go(za, {isAxis: !0, date: e}, (function (e, n, r, o) {
                                return go("div", {
                                    ref: e,
                ...
                type: "footer",
                isSticky: !0,
                chunks: [{key: "axis", content: Oa}, {key: "cols", content: Oa}]
            }), go(jo, {viewSpec: u.viewSpec, elRef: this.rootElRef}, (function (e, t) {
                return go("div", {
                    className: ["fc-timegrid"].concat(t).join(" "),
                    ref: e
                }, go(l, {
    ...
    var hl = function () {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go("tbody", null, e.slatMetas.map((function (i, a) {
                ...
                return go("tr", {key: i.key, ref: o.createRef(i.key)}, e.axis && go(ll, r({}, i)), go(Ao, {
                    hookProps: s,
                    ...
                    return go("td", {ref: e, className: l.concat(t).join(" "), "data-time": i.isoTimeStr}, r)
                })))
            })))
        }, t
    }(ko), gl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.rootElRef = yo(), t.slatElRefs = new wa, t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, e.tableColGroupNode, go(vl, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas})))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing()
        }, t.prototype.componentDidUpdate = function () {
            this.updateSizing()
            ...
            n.onCoords && null !== n.clientWidth && this.rootElRef.current.offsetHeight && n.onCoords(new hl(new uo(this.rootElRef.current, (e = this.slatElRefs.currentMap, n.slatMetas.map((function (t) {
                return e[t.key]
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(es, {
                ...
                return go("a", {
                    ...
                    onClick: a
                }, go("div", {ref: o, className: "fc-timegrid-more-link-inner fc-sticky"}, i))
            }))
        }, t
    }(ko);
    ...
    function Dl(e, t, n) {
        ...
        var i, a, s = Oi(o.addSegs(e)), l = function (e) {
            var t = e.entriesByLevel, n = Rl((function (e, t) {
                return e + ":" + t
            }), (function (o, i) {
                var a = bl(function (e, t, n) {
                    for (var r = e.levelCoords, o = e.entriesByLevel, i = o[t][n], a = r[t] + i.thickness, s = r.length, l = t; l < s && r[l] < a; l += 1) ;
                    for (; l < s; l += 1) {
                        for (var u = o[l], c = void 0, d = Ui(u, i.spanStart, Ni), p = d[0] + d[1], f = p; (c = u[f]) && c.spanStart < i.spanEnd;) f += 1;
        ...
        return i = l, 1, a = Rl((function (e, t, n) {
            return Hi(e)
        }), (function (e, t, n) {
            var o, i = e.nextLevelNodes, s = e.thickness, l = s + n, u = s / l, c = [];
            if (i.length) for (var d = 0, p = i; d < p.length; d++) {
                var f = p[d];
                if (void 0 === o) o = (h = a(f, t, l))[0], c.push(h[1]); else {
                    var h = a(f, o, 0);
                    c.push(h[1])
                }
            } else o = 1;
    ...
    function bl(e, t) {
        ...
        return a.sort(Cl), [a.map(wl), a[0][1]]
    }
    ...
    var _l = nn({hour: "numeric", minute: "2-digit", meridiem: !1}), Tl = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return this.props.isShort && e.push("fc-timegrid-event-short"), go(Va, r({}, this.props, {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(ja, {
                ...
                return t && go("div", {className: "fc-timegrid-col-misc", ref: e}, t)
            }))
        }, t
    }(ko), xl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.sortEventSegs = Ft(Xn), t.computeFgSegPlacements = Ft(Dl), t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(qa, {
                ...
                }, u, t.extraDataAttrs), go("div", {className: "fc-timegrid-col-frame"}, go("div", {className: "fc-timegrid-col-bg"}, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), go("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(s, a)), go("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))), go("div", {className: "fc-timegrid-now-indicator-container"}, e.renderNowIndicator(t.nowIndicatorSegs)), go(kl, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
            ...
            var i = this.props;
            return i.forPrint ? Ml(e, i) : i.slatCoords ? this.renderPositionedFgSegs(e, t, n, r, o) : null
            ...
            var a = this, s = this.context.options, l = s.eventMaxStack, u = s.eventShortHeight, c = s.eventOrderStrict,
                ...
                g = this.buildSegInputs(e), m = v ? Dl(g) : this.computeFgSegPlacements(g, c, l), y = m.segRects,
                E = m.hiddenGroups;
            return go(Eo, null, this.renderHiddenGroups(E, e), y.map((function (s) {
            ...
            return go(Eo, null, e.map((function (e) {
            ...
            var i = this.buildSegInputs(e).map((function (i) {
                ...
                }, "bg-event" === t ? go(Za, r({seg: a}, tr(a, o.todayRange, o.nowDate))) : Ya(t))
            }));
            return go(Eo, null, i)
        }, t.prototype.renderNowIndicator = function (e) {
            var t = this.props, n = t.slatCoords, r = t.date;
            return n ? e.map((function (e, t) {
                return go(za, {isAxis: !1, date: r, key: t}, (function (t, o, i, a) {
                    return go("div", {
                        ref: t,
    ...
    function Ml(e, t) {
        ...
        return go(Eo, null, e.map((function (e) {
            ...
            return go("div", {key: t, style: {visibility: l[t] ? "hidden" : ""}}, go(Tl, r({
                seg: e,
                isDragging: !1,
                isResizing: !1,
                isDateSelecting: !1,
    ...
    var Il = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitFgEventSegs = Ft(ml), t.splitBgEventSegs = Ft(ml), t.splitBusinessHourSegs = Ft(ml), t.splitNowIndicatorSegs = Ft(ml), t.splitDateSelectionSegs = Ft(ml), t.splitEventDrag = Ft(yl), t.splitEventResize = Ft(yl), t.rootElRef = yo(), t.cellElRefs = new wa, t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, t.tableColGroupNode, go("tbody", null, go("tr", null, t.axis && go("td", {className: "fc-timegrid-col fc-timegrid-axis"}, go("div", {className: "fc-timegrid-col-frame"}, go("div", {className: "fc-timegrid-now-indicator-container"}, "number" == typeof n && go(za, {
                isAxis: !0,
                date: t.nowDate
            }, (function (e, t, r, o) {
                return go("div", {
            ...
            var e, t = this.props;
            t.onColCoords && null !== t.clientWidth && t.onColCoords(new uo(this.rootElRef.current, (e = this.cellElRefs.currentMap, t.cells.map((function (t) {
                return e[t.key]
            }))), !0, !1))
        }, t
    }(ko), Pl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = Ft(Nl), t.state = {slatCoords: null}, t.handleRootEl = function (e) {
    ...
    var Hl = function (e) {
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildDayRanges = Ft(Al), t.slicer = new Hl, t.timeColsRef = yo(), t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(aa, {unit: a ? "minute" : "day"}, (function (l, u) {
                return go(Pl, r({ref: e.timeColsRef}, e.slicer.sliceProps(t, o, null, n, s), {
                    forPrint: t.forPrint,
                    axis: t.axis,
                    dateProfile: o,
    ...
    var Ul = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];

    function Ll(e, t, n, r, o) {
        for (var i = new Date(0), a = e, s = kt(0), l = n || function (e) {
            var t, n, r;
            for (t = Ul.length - 1; t >= 0; t -= 1) if (null !== (r = Ht(n = kt(Ul[t]), e)) && r > 1) return n;
            return e
        }(r), u = []; Nt(a) < Nt(t);) {
    ...
    var Wl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildTimeColsModel = Ft(Vl), t.buildSlatMetas = Ft(Ll), t
        }
    ...
    var Fl = No({
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = e.dayDate, n = e.todayRange, o = this.context, i = o.theme, a = o.dateEnv,
                s = o.options, l = o.viewApi, u = Xr(t, n), c = s.listDayFormat ? a.format(t, s.listDayFormat) : "",
                d = s.listDaySideFormat ? a.format(t, s.listDaySideFormat) : "", p = s.navLinks ? $r(t) : null,
                f = r({date: a.toDate(t), view: l, text: c, sideText: d, navLinkData: p}, u),
                h = ["fc-list-day"].concat(Kr(u, i));
            return go(Ao, {
                hookProps: f,
    ...
    function Bl(e) {
        ...
        return go(Eo, null, e.text && go("a", r({className: "fc-list-day-text"}, t), e.text), e.sideText && go("a", r({className: "fc-list-day-side-text"}, t), e.sideText))
    }

    var jl = nn({hour: "numeric", minute: "2-digit", meridiem: "short"}), Gl = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = e.seg, r = t.options.eventTimeFormat || jl;
            return go(Wa, {
                seg: n,
                timeText: "",
                disableDragging: !0,
                ...
                return go("tr", {
                    ...
                    if (!1 !== r.displayEventTime) {
                        ...
                        if (o.allDay ? a = !0 : Hn(e.eventRange.range) ? e.isStart ? s = er(e, t, n, null, null, i.range.start, e.end) : e.isEnd ? s = er(e, t, n, null, null, e.start, i.range.end) : a = !0 : s = er(e, t, n), a) {
                            ...
                            return go(Ao, {
                                ...
                                return go("td", {className: ["fc-list-event-time"].concat(t).join(" "), ref: e}, r)
                            }))
                        }
                        return go("td", {className: "fc-list-event-time"}, s)
                    }
                    return null
                }(n, r, t), go("td", {className: "fc-list-event-graphic"}, go("span", {
                    className: "fc-list-event-dot",
                    style: {borderColor: s.borderColor || s.backgroundColor}
                })), go("td", {className: "fc-list-event-title", ref: i}, a))
            }))
        }, t
    }(ko);
    ...
    function ql(e) {
        ...
        return go("a", r({}, n ? {href: n} : {}), t.title)
    }
    ...
    var Zl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = Ft(Kl), t.eventStoreToSegs = Ft(t._eventStoreToSegs), t.setRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return go(jo, {viewSpec: n.viewSpec, elRef: this.setRootEl}, (function (n, o) {
                return go("div", {ref: n, className: r.concat(o).join(" ")}, go(Ca, {
            ...
            return go(Ao, {
                ...
                return go("div", {
                    ...
                    ref: e
                }, go("div", {className: "fc-list-empty-cushion", ref: n}, r))
            }))
            ...
            return go(aa, {unit: "day"}, (function (e, n) {
                for (var s = [], l = 0; l < a.length; l += 1) {
                    var u = a[l];
                    if (u) {
                        var c = t[l].toISOString();
                        s.push(go(zl, {key: c, dayDate: t[l], todayRange: n}));
                        for (var d = 0, p = u = Xn(u, i.eventOrder); d < p.length; d++) {
                            var f = p[d];
                            s.push(go(Gl, r({
                ...
                return go("table", {className: "fc-list-table " + o.getClass("table")}, go("tbody", null, s))
            }))
            ...
            var n, r, o, i = this.context.dateEnv, a = this.context.options.nextDayThreshold, s = e.range,
                l = e.def.allDay, u = [];
            for (n = 0; n < t.length; n += 1) if ((r = Ln(s, t[n])) && (o = {
                component: this,
                eventRange: e,
                start: r.start,
                end: r.end,
    ...
    }, Ql.prototype.baseIconClass = "fa", Ql.prototype.iconClasses = {
        close: "fa-times",
        prev: "fa-chevron-left",
        next: "fa-chevron-right",
        prevYear: "fa-angle-double-left",
        nextYear: "fa-angle-double-right"
    }, Ql.prototype.rtlIconClasses = {
        prev: "fa-chevron-right",
        next: "fa-chevron-left",
        prevYear: "fa-angle-double-right",
        nextYear: "fa-angle-double-left"
    }, Ql.prototype.iconOverrideOption = "bootstrapFontAwesome", Ql.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome", Ql.prototype.iconOverridePrefix = "fa-";
    var eu = No({themeClasses: {bootstrap: Ql}}), tu = No({
        eventSourceDefs: [{
            parseMeta: function (e) {
                ...
                if (l) {
                    var u = function (e) {
                        ...
                        var i, a, s;
                        return o.canComputeOffset ? (a = o.formatIso(e.start), s = o.formatIso(e.end)) : (a = Ke(e.start, -1).toISOString(), s = Ke(e.end, 1).toISOString()), i = r(r({}, n || {}), {
                            key: t,
                            timeMin: a,
                            timeMax: s,
                            singleEvents: !0,
    ...
    return hi.push(Hs, il, Fl, Jl, eu, tu), e.BASE_OPTION_DEFAULTS = on, e.BASE_OPTION_REFINERS = rn, e.BaseComponent = ko, e.BgEvent = Za, e.BootstrapTheme = Ql, e.Calendar = as, e.CalendarApi = Dr, e.CalendarContent = $i, e.CalendarDataManager = Si, e.CalendarDataProvider = Ii, e.CalendarRoot = ea, e.Component = vo, e.ContentHook = Lo, e.CustomContentRenderContext = Uo, e.DateComponent = Po, e.DateEnv = Mr, e.DateProfileGenerator = Xo, e.DayCellContent = ja, e.DayCellRoot = qa, e.DayGridView = rl, e.DayHeader = la, e.DaySeriesModel = ca, e.DayTable = nl, e.DayTableModel = da, e.DayTableSlicer = tl, e.DayTimeCols = Ol, e.DayTimeColsSlicer = Hl, e.DayTimeColsView = Wl, e.DelayedRunner = mi, e.Draggable = Is, e.ElementDragging = zi, e.ElementScrollController = po, e.Emitter = lo, e.EventApi = br, e.EventRoot = Wa, e.EventSourceApi = ye, e.FeaturefulElementDragging = ys, e.Fragment = Eo, e.Interaction = Li, e.ListView = Zl, e.MoreLinkRoot = es, e.MountHook = Vo, e.NamedTimeZoneImpl = function (e) {
        ...
        return {defs: {}, instances: {}}
    }, e.createEventInstance = pt, e.createEventUi = bn, e.createFormatter = nn, e.createPlugin = No, e.createPortal = Do, e.createRef = yo, e.diffDates = On, e.diffDayAndTime = et, e.diffDays = Qe, e.diffPoints = jr, e.diffWeeks = Je, e.diffWholeDays = nt, e.diffWholeWeeks = tt, e.disableCursor = He, e.elementClosest = Se, e.elementMatches = De, e.enableCursor = Oe, e.eventTupleToStore = vn, e.filterEventStoreDefs = yn, e.filterHash = vt, e.findDirectChildren = function (e, t) {
        for (var n = e instanceof HTMLElement ? [e] : e, r = [], o = 0; o < n.length; o += 1) for (var i = n[o].children, a = 0; a < i.length; a += 1) {
            var s = i[a];
            t && !De(s, t) || r.push(s)
        }
        return r
    }, e.findElements = be, e.flexibleCompare = Be, e.flushToDom = bo, e.formatDate = function (e, t) {
        void 0 === t && (t = {});
        var n = Ar(t), r = nn(t), o = n.createMarkerMeta(e);
        ...
        var r = Ar("object" == typeof n && n ? n : {}), o = nn(n), i = r.createMarkerMeta(e), a = r.createMarkerMeta(t);
    ...
    }, e.getAllowYScrolling = Ta, e.getCanVGrowWithinCell = Gr, e.getClippingParents = ao, e.getDateMeta = Xr, e.getDayClassNames = Kr, e.getDefaultEventEnd = pr, e.getElSeg = qn, e.getEntrySpanEnd = Ni, e.getEventClassNames = nr, e.getIsRtlScrollbarOnLeft = eo, e.getRectCenter = Br, e.getRelevantEvents = gn, e.getScrollGridClassNames = Na, e.getScrollbarWidths = to, e.getSectionClassNames = Ha, e.getSectionHasLiquidHeight = _a, e.getSegMeta = tr, e.getSlotClassNames = function (e, t) {
    ...
    }, e.memoizeObjArg = zt, e.mergeEventStores = mn, e.multiplyDuration = It, e.padStart = je, e.parseBusinessHours = Wr, e.parseClassNames = En, e.parseDragMeta = Gi, e.parseEventDef = In, e.parseFieldSpecs = Ve, e.parseMarker = xr, e.pointInsideRect = Vr, e.preventContextMenu = Le, e.preventDefault = Te, e.preventSelection = Ae, e.rangeContainsMarker = zn, e.rangeContainsRange = Fn, e.rangesEqual = Wn, e.rangesIntersect = Vn, e.refineEventDef = xn, e.refineProps = pn, e.removeElement = Ee, e.removeExact = function (e, t) {
        for (var n = 0, r = 0; r < e.length;) e[r] === t ? (e.splice(r, 1), n += 1) : r += 1;
        return n
    }, e.render = mo, e.renderChunkContent = ka, e.renderFill = Ya, e.renderMicroColGroup = Ma, e.renderScrollShim = Oa, e.requestJson = di, e.sanitizeShrinkWidth = Ia, e.setElSeg = Gn, e.setRef = Io, e.sliceEventStore = Bn, e.sliceEvents = function (e, t) {
        return Bn(e.eventStore, e.eventUiBases, e.dateProfile.activeRange, t ? e.nextDayThreshold : null).fg
    }, e.sortEventSegs = Xn, e.startOfDay = rt, e.translateRect = function (e, t, n) {
        return {left: e.left + t, right: e.right + t, top: e.top + n, bottom: e.bottom + n}
    }, e.triggerDateSelect = cr, e.unmountComponentAtNode = Co, e.unpromisify = so, e.version = "5.7.2", e.whenTransitionDone = Ie, e.wholeDivideDurations = Ht, Object.defineProperty(e, "__esModule", {value: !0}), e
}({});
