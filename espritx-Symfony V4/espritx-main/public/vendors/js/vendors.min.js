!function (e, t) {
    ...
    var T = {
        ...
        "click-rail": function (e) {
            ...
            function u(e) {
                if (a(e)) {
                    var t = s(e), n = {pageX: t.pageX, pageY: t.pageY}, i = n.pageX - f.pageX, l = n.pageY - f.pageY;
    ...
    K(J, Y = Error), r = J, Z.prototype.getElement = function () {
        ...
        if (e = e.url, !j(e)) return n = new ("socket" === t ? u : p)(n, this.complete), this.elements.push(n)
    ...
    "use strict";
    var e = [], t = e.forEach, n = e.slice;

    function i(e) {
        return t.call(n.call(arguments, 1), (function (t) {
    ...
    function a(e, t, n, i, o) {
        i && "object" === r(i) && (o || (i._t = new Date), i = s("", i).slice(1)), t.queryStringParams && (e = s(e, t.queryStringParams));
        try {
            var a;
            ...
            if (l = "function" == typeof l ? l() : l) for (var c in l) a.setRequestHeader(c, l[c]);
    ...
    var c = function () {
        ...
        return (t = [{
            key: "init", value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                this.services = e, this.options = i(t, this.options || {}, l())
            }
        }, {
    ...
    var o = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, r = function (e, t, n) {
        ...
        name: "cookie", lookup: function (e) {
            ...
            t.lookupCookie && "undefined" != typeof document && function (e, t, n, i) {
                ...
                n && (o.expires = new Date, o.expires.setTime(o.expires.getTime() + 60 * n * 1e3)), i && (o.domain = i), document.cookie = r(e, encodeURIComponent(t), o)
        ...
        if (null !== p) return p;
        try {
            p = "undefined" !== window && null !== window.sessionStorage, window.sessionStorage.setItem("i18next.translate.boo", "foo"), window.sessionStorage.removeItem("i18next.translate.boo")
        } catch (e) {
            p = !1
        }
        return p
        ...
        function e(t) {
            ...
            !function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.type = "languageDetector", this.detectors = {}, this.init(t, n)
        }
        ...
        return (t = [{
            key: "init", value: function (e) {
                ...
                this.services = e, this.options = i(t, this.options || {}, {
                ...
                }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(s), this.addDetector(a), this.addDetector(u), this.addDetector(f), this.addDetector(d), this.addDetector(g), this.addDetector(m), this.addDetector(y)
            }
        }, {
    ...
    e.fn.TouchSpin = function (n) {
        ...
        return this.each((function () {
            ...
            g.data("alreadyinitialized") || (g.data("alreadyinitialized", !0), t += 1, g.data("spinnerid", t), g.is("input") ? ("" !== (r = e.extend({}, i, m, function () {
                var t = {};
