...
public class AddConver extends BaseForm {
    public AddConver() {
        this(Resources.getGlobalResources());
    }
    public AddConver(Resources resourceObjectInstance) {
...
r1.remove(index);
        ...
        for (int i = 0; i < l1.size(); i++) {
            listModel.addItem( l1.get(i).email.get());
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                for (int i = 0; i < l1.size(); i++) {
                   ...
                   c4.participants.add(l1.get(i));
                       c4.participants.add(AuthenticationService.getAuthenticatedUser());

                      s2.add_Conversation(c4);
                   }
                }
            }
        });
